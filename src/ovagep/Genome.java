...
package ovagep;
/**
 * Esta clase representa a los personajes que componen los genes como las funciones
 * y terminales. Muy básico, pero nos permite ocultar los terminales / matrices
 * funciones y de lujo nada detrás de las escenas más tarde que podrían ser de
 * su interés.
 *
...
public class Genome {
    ...
    /**
     * Longitud de la cola en un gen. La cola sólo puede contener caracteres terminal.
     * Este es un requisito para garantizar que todo el cromosoma resultante después
     * de un operador genético se aplica es un cromosoma válida.
     *
