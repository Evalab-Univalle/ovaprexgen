...
/**
 * Esta clase contiene todos los operadores en los genes que pueden ocurrir de
 * forma individual (como la mutación) o durante la reproducción (por ejemplo,
 * la recombinación)

 * Los usuarios que deseen personalizar cualquiera de estos puede extender esta clase
 * y volver a poner en práctica lo que los métodos que les gusta. Una población
 * tendrá una instancia de este objeto, ya que opera en esa población específica.
 * Las probabilidades de los operadores se producen también existen en este objeto
 * en lugar de en otra parte. Esto permite a otros operadores a crear sus
 * probabilidades y los acompañará.
 * Las probabilidades de los operadores se producen también existen en este objeto
 * en lugar de en otra parte. Esto permite a otros operadores a crear sus
 * probabilidades y los acompañará.
 *
...
public class GeneticOperators {
    ...
    /**
     * Dada una cadena y el número de mutaciones a causa, devolver una cadena con
     * ese número de mutaciones. Tenga en cuenta que un objeto externo tendrá la
     * probabilidad de mutación de este objeto, y luego lo utilizan para determinar
     * el parámetro numMutations.
     * 
    ...
    /**
     * DDada una matriz de dos elementos que contienen dos cromosomas de cadena,
     * lleve a cabo una recombinación de un punto entre ellos y devolver una
     * nueva matriz de dos elementos con los nuevos cromosomas.
     * Esto es llamado por un objeto externo que ha utilizado la probabilidad almacenada
     * en este objeto para determinar si una recombinación de un punto debe ocurrir.
     *
    ...
    /**
     * Dada una matriz de dos elementos que contienen dos cromosomas de cadena,
     * lleve a cabo una recombinación de dos puntos entre ellos y devolver una
     * nueva matriz de dos elementos con los nuevos cromosomas.
     * Esto es llamado por un objeto externo que ha utilizado la probabilidad
     * almacenada en este objeto para determinar si una recombinationshould de
     * dos puntos se producen.
     *
     * @param    s    The array of chromosomes.  Assume length is two.
     *                eventually, if this is not true we will throw an
     *                exception.
